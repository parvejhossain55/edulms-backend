...
const getStudentSubmittedAssignmentService = async (
    {courseId, studentId, pageNo, perPage, keyword}
)=>{
        ...
        {$facet: {
                ...
                rows:[
                    ...
                    },
                    {
                        $lookup: {
                            from: 'coursemodules',
                            localField: 'assignment.courseModuleId',
                            foreignField: '_id',
                            as: 'module'
                        }
                    },
...
module.exports = {
    ...
    getStudentSubmittedAssignmentService
}